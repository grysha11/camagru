...
type ServerInterface interface {
	...
	// GitHubOAuthLogin Start GitHub OAuth2 login
	// (GET /api/oauth/github/login)
	GitHubOAuthLogin(w http.ResponseWriter, r *http.Request)
	// ListOverlays List available overlay PNGs
	// (GET /api/overlays)
	ListOverlays(w http.ResponseWriter, r *http.Request)
	// ListPosts List public posts, paginated
	// (GET /api/posts)
	ListPosts(w http.ResponseWriter, r *http.Request, params ListPostsParams)
	// CreatePost Capture/upload a photo composited with an overlay
	// (POST /api/posts)
	CreatePost(w http.ResponseWriter, r *http.Request)
	// ListMyPosts List the authenticated user's own posts
	// (GET /api/posts/mine)
	...
	// ListComments List comments on a post
